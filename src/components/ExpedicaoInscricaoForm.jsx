...
function ExpedicaoInscricaoForm({ isOpen, onClose, onSuccess, title, description, tipoInscricao, eventoSelecionado, eventosDisponiveis }) {
  ...
  useEffect(() => {
    ...
    const savedPerfil = localStorage.getItem('expedicao_perfil')
  ...
  const validate = () => {
    ...
    if (!formData.perfil) {
      newErrors.perfil = 'É necessário selecionar um perfil'
    }
        ...
        {step === 1 ? (
          ...
          <div className="expedicao-inscricao-step" key="step-2">
            ...
            <form className="expedicao-inscricao-form" onSubmit={handleSubmit}>
              ...
              <div className="expedicao-inscricao-field">
                <label htmlFor="perfil" className="expedicao-inscricao-label">
                  Qual perfil você se identifica? <span className="required">*</span>
                </label>
                <select
                  id="perfil"
                  name="perfil"
                  ...
                  onChange={handleChange}
                  className={`expedicao-inscricao-select ${errors.perfil ? 'error' : ''}`}
                  required
                >
